    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                ...
                <a href="https://fieldnotes.rangeway.energy" target="_blank" rel="noopener noreferrer" class="btn-secondary">Subscribe to Field Notes</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="location-content">
                <div class="location-text">
                    ...
                    <p>Positioned on the LA-Vegas corridor at the gateway to Death Valley National Park—which draws 1.1 million visitors annually—our flagship Basecamp serves travelers exploring one of America's most dramatic desert landscapes.</p>>
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <div style="text-align: center;">
                <a href="https://investors.rangeway.energy" target="_blank" rel="noopener noreferrer" class="btn-secondary cta-btn">Investor Portal</a>
                <a href="https://fieldnotes.rangeway.energy" target="_blank" rel="noopener noreferrer" class="btn-secondary cta-btn">Subscribe to Field Notes</a>
            </div>
        </div>
    </section>
</main>
